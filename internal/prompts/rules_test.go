...
func TestEvaluateRules(t *testing.T) {
	tests := []struct {
		...
		{name: "caught up rewatch silent", in: Batch{NewEpisodeIDs: []int64{2}, Seasons: []SeasonState{{SeasonID: 10, ShowID: 100, InventoryKnown: true, Episodes: []Episode{{ID: 1, Number: 1, Released: true, Watched: true, PreviouslyWatched: true, Normal: true}, {ID: 2, Number: 2, Released: true, Watched: true, PreviouslyWatched: true, Normal: true}, {ID: 3, Number: 3, Released: false, Normal: true}}}}}, want: []Decision{}},
		{name: "binge backlog silent", in: Batch{NewEpisodeIDs: []int64{1}, Seasons: []SeasonState{{SeasonID: 10, ShowID: 100, InventoryKnown: true, Episodes: []Episode{{ID: 1, Number: 1, Released: true, Watched: true, Normal: true}, {ID: 2, Number: 2, Released: true, Normal: true}, {ID: 3, Number: 3, Released: true, Normal: true}}}}}, want: []Decision{}},
		...
		{name: "completed season rewatch silent", in: Batch{NewEpisodeIDs: []int64{3}, Seasons: []SeasonState{{SeasonID: 10, ShowID: 100, InventoryKnown: true, Episodes: []Episode{{ID: 1, Number: 1, Released: true, Watched: true, PreviouslyWatched: true, Normal: true}, {ID: 2, Number: 2, Released: true, Watched: true, PreviouslyWatched: true, Normal: true}, {ID: 3, Number: 3, Released: true, Watched: true, PreviouslyWatched: true, Normal: true}}}}}, want: []Decision{}},
		...
		{name: "uncertain metadata silent", in: Batch{NewEpisodeIDs: []int64{2}, Seasons: []SeasonState{{SeasonID: 10, ShowID: 100, InventoryKnown: false, Episodes: []Episode{{ID: 1, Number: 1, Released: true, Watched: true, Normal: true}, {ID: 2, Number: 2, Released: true, Watched: true, Normal: true}}}}}, want: []Decision{}},
		{name: "ignored show silent", in: Batch{NewEpisodeIDs: []int64{2}, IgnoredShowIDs: map[int64]bool{100: true}, Seasons: []SeasonState{{SeasonID: 10, ShowID: 100, InventoryKnown: true, Episodes: []Episode{{ID: 1, Number: 1, Released: true, Watched: true, Normal: true}, {ID: 2, Number: 2, Released: true, Watched: true, Normal: true}}}}}, want: []Decision{}},
